...
{
    /**
     * Handle of the resource that serves as container for CyberCache options.
     *
     * @var resource
     */
    private $c3_resource;
    ...
    /**
     * Application state object, used to differentiate front- and back-end calls.
     *
     * @var State
     */
    private $c3_state;
     ...
     *
     * @param DeploymentConfig $config Deployment configuration object.
     * @param State $state Application state object.
     * @param ScopeConfigInterface $scope Scope configuration object.
    ...
    {
        $lifetime = 0;
        if ($this->c3_state->getAreaCode() == Area::AREA_ADMINHTML) {
            ...
            if ($this->c3_magento_lifetime == 'all') {
                $lifetime = (int) $this->c3_scope->getValue(
